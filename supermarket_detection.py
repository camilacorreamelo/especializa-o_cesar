# -*- coding: utf-8 -*-
"""supermarket-detection.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GNVwfWegwBISDshcQJDM5_mXD6i6FbXd
"""
...
project = rf.workspace("especializao").project("supermarket-oqn4b")
...
!python train.py --img 640 --batch 50 --epochs 1000 --data {dataset.location}/data.yaml --weights yolov5s.pt --cache

# Commented out IPython magic to ensure Python compatibility.
# %cp -r /content/yolov5/runs/train /content/gdrive/MyDrive/Supermarket/
